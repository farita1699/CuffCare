...
"}")
        ...
        self.label_top_info_1.setMinimumSize(QtCore.QSize(0, 20))
        ...
        self.pushButton_6 = QtWidgets.QPushButton(self.frame_top_info)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_6.setStyleSheet("color: rgb(98, 103, 111);\n"
...
"}")
        ...
        self.label_6.setStyleSheet("margin-bottom: 40px;\n"
"font-weight: 100;")
        ...
        self.verticalWidget.setMinimumSize(QtCore.QSize(700, 120))
        ...
        self.UsernameInput = QtWidgets.QLineEdit(self.verticalWidget)
        ...
        self.UsernameInput.setMinimumSize(QtCore.QSize(200, 45))
        self.UsernameInput.setLayoutDirection(QtCore.Qt.LeftToRight)
...
"")
        ...
        self.verticalLayout_8.addWidget(self.UsernameInput)
        ...
        self.PasswordInput = QtWidgets.QLineEdit(self.verticalWidget)
...
"")
        ...
        self.verticalLayout_8.addWidget(self.PasswordInput)
...
"}")
        ...
        self.verticalLayout_10.addWidget(self.verticalWidget, 0, QtCore.Qt.AlignHCenter)
        ...
        self.frame.setMinimumSize(QtCore.QSize(0, 102))
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelVersion_3.sizePolicy().hasHeightForWidth())
        self.labelVersion_3.setSizePolicy(sizePolicy)
        self.labelVersion_3.setMinimumSize(QtCore.QSize(0, 10))
        ...
        self.gridLayout.addWidget(self.labelVersion_3, 1, 0, 1, 1)
        ...
        self.frame_2.setMinimumSize(QtCore.QSize(0, 102))
...
"}")
        ...
        self.gridLayout_2.addWidget(self.pushButton_3, 0, 5, 7, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.pushButton_2, 0, 4, 7, 1)
...
"")
        ...
        self.widget.setMinimumSize(QtCore.QSize(500, 40))
        self.widget.setMaximumSize(QtCore.QSize(16777215, 200))
        self.widget.setStyleSheet("border: 5px solid rgba(80, 80, 80, 255);\n"
"background-color: rgba(27, 29, 35, 160);\n"
"border-radius: 10px;\n"
"")
...
"border: 3px solid rgba(27, 29, 35, 160);")
        ...
        self.gridLayout_2.addWidget(self.widget, 0, 2, 6, 1)
...
"border-radius: 5px;")
        ...
        self.gridLayout_4.addWidget(self.label_8, 3, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frame_4, 4, 2, 1, 1)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title_bar_top.setText(_translate("MainWindow", "CuffCare"))
        ...
        self.label_top_info_1.setText(_translate("MainWindow", "An interactive application designed for both patients and physicians to effectively track the progress of rotator cuff injury rehabilitation."))
        self.pushButton_6.setText(_translate("MainWindow", " | HOME"))
        self.label_user_icon.setText(_translate("MainWindow", "G"))
        self.label_6.setText(_translate("MainWindow", "CuffCare"))
        ...
        self.lineEdit.setText(_translate("MainWindow", "Ex. C:\\Downloads\\Session1.csv"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Your Password"))
        self.pushButton.setText(_translate("MainWindow", "Load session"))
        self.labelVersion_3.setText(_translate("MainWindow", "Session not loaded. Click on \"Load session\" to select a previous session."))
        self.pushButton_3.setText(_translate("MainWindow", "End session"))
        self.pushButton_2.setText(_translate("MainWindow", "Start"))
        self.comboBox.setItemText(0, _translate("MainWindow", "One arm lateral raise"))
        self.label_3.setText(_translate("MainWindow", "Current Exercise"))
        self.label_11.setText(_translate("MainWindow", "Accuracy"))
        self.label_10.setText(_translate("MainWindow", "0"))
        self.label_9.setText(_translate("MainWindow", "Angles"))
        self.label_12.setText(_translate("MainWindow", "0"))
        self.label_7.setText(_translate("MainWindow", "Acceleration vs Time"))
        self.label_8.setText(_translate("MainWindow", "Spatial View"))
        self.label_5.setText(_translate("MainWindow", "Angular velocity vs Time"))
        self.label_4.setText(_translate("MainWindow", "Angle vs Time"))
        self.label_credits.setText(_translate("MainWindow", "By: Aiden Simpson, Ali Umar, Jerry Wan, Matthew Ho"))
